...
extern "C" {
    ...
    static SKP_Silk_Resampler_2_3_COEFS_LQ: [libc::c_short; 6];
}
#[no_mangle]
pub unsafe extern "C" fn SKP_Silk_resampler_down2_3(
    ...
    let mut buf: [libc::c_int; 484] = [0; 484];
    ...
    loop {
        ...
        SKP_Silk_resampler_private_AR2(
            ...
            in_0,
            SKP_Silk_Resampler_2_3_COEFS_LQ.as_ptr(),
            nSamplesIn,
        );
        ...
        while counter > 2 as libc::c_int {
            res_Q6 = (*buf_ptr.offset(0 as libc::c_int as isize) >> 16 as libc::c_int)
                * SKP_Silk_Resampler_2_3_COEFS_LQ[2 as libc::c_int as usize]
                    as libc::c_int
            ...
            res_Q6 = res_Q6
                + ((*buf_ptr.offset(1 as libc::c_int as isize) >> 16 as libc::c_int)
                    * SKP_Silk_Resampler_2_3_COEFS_LQ[3 as libc::c_int as usize]
                        as libc::c_int
            ...
            res_Q6 = res_Q6
                + ((*buf_ptr.offset(2 as libc::c_int as isize) >> 16 as libc::c_int)
                    * SKP_Silk_Resampler_2_3_COEFS_LQ[5 as libc::c_int as usize]
                        as libc::c_int
            ...
            res_Q6 = res_Q6
                + ((*buf_ptr.offset(3 as libc::c_int as isize) >> 16 as libc::c_int)
                    * SKP_Silk_Resampler_2_3_COEFS_LQ[4 as libc::c_int as usize]
                        as libc::c_int
            ...
            *fresh0 = (if (if 6 as libc::c_int == 1 as libc::c_int {
            ...
            res_Q6 = (*buf_ptr.offset(1 as libc::c_int as isize) >> 16 as libc::c_int)
                * SKP_Silk_Resampler_2_3_COEFS_LQ[4 as libc::c_int as usize]
                    as libc::c_int
