...
#[macro_export]
macro_rules! skp_add_l_shift {
    ($a:expr,$b:expr,$shift:expr) => {{
        $a + crate::skp_l_shift!($b,$shift)
    }}
}
...
#[macro_export]
macro_rules! skp_s_mla_t_t_ovflw {
    ($a32:expr,$b32:expr,$c32:expr) => {{
        crate::skp_add32_ovflw!($a32,crate::skp_s_mul_t_t!($b32,$c32))
    }}
}
...
#[macro_export]
macro_rules! i32_to_i16 {
    ($a:expr) => {{
        ($a as i16 , ($a >> 16) as i16)
    }}
}
