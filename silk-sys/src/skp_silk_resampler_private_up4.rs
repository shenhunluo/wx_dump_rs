...
pub fn skp_silk_resampler_private_up4(s: &mut [i32], out: &mut [i16], in_0: &[i16], len: usize) {
    for k in 0..len {
        ...
        let mut out16 = skp_sat_16!(skp_r_shift_round!(out32, 10), i32) as i16;
        out[4 * k] = out16;
        out[4 * k + 1] = out16;
        ...
        out16 = skp_sat_16!(skp_r_shift_round!(out32, 10), i32) as i16;
        out[4 * k + 2] = out16;
        out[4 * k + 3] = out16;
    }
}
